...
id: LOG-{YYYYMMDD}T{HHmmss}-{AUTHOR}-1.00
type: LOG
date: {YYYY-MM-DD}T{HH:mm:ss}
author: {YOUR INITIALS}
process: {EXPERIMENT OR PROCESS NAME}
sample: {SAMPLE ID, if applicable}
equipment: {EQUIPMENT USED, if applicable}
status: Draft
tags: []
related: []
---
